...
class YoutubeDownloader():
        ...
        def download_video(self):
                if self.video_url.get() == "":
                        ...
                        try:
                                ...
                                self.stream = self.video.streams.filter(progressive=True, file_extension='mp4',only_audio=False).order_by('resolution').asc().first()
                                ...
                                self.start_downloading = Label(self.root,text="Video downloading .....",fg="orange",font=('verdana',10,'bold'),bg="white")
                                ...
                                self.dow_success = Label(self.root,text="Video downloaded successfully .....",fg="orange",font=('verdana',10,'bold'),bg="white")
        ...
        def download_playlist(self):
                if self.playlist_url.get() == "":
                        ...
                        try:
                                ...
                                self.start_downloading = Label(self.root,text="Playlist downloading .....",fg="orange",font=('verdana',10,'bold'),bg="white")
                                self.start_downloading.place(x=40,y=10)
                                ...
                                self.dow_success = Label(self.root,text="Playlist downloaded successfully .....",fg="orange",font=('verdana',10,'bold'),bg="white")
                                self.dow_success.place(x=10,y=120)
        ...
        def __init__(self):
                ...
                self.l1 = Label(self.root,text="Youtube Downloader",font=('verdana',15,'bold'),bg="white",fg="orange")
                ...
                self.design2 = Label(self.root,bg="orange",width=20)
                self.design2.place(x=360,y=45)

                self.design3 = Label(self.root,bg="orange",width=3,height=6)
                ...
                self.frame1 = LabelFrame(self.root,text="Download Video",width=180,height=180,font=('verdana',10,'bold'),bg="white",fg="orange",borderwidth=5,relief=SUNKEN,highlightcolor="orange",highlightbackground="orange")
                ...
                self.video_url = Entry(self.frame1,width=24,relief=SUNKEN,borderwidth=2,bg="orange",fg="white")
                ...
                self.video_path = Entry(self.frame1,width=15,relief=SUNKEN,borderwidth=2,bg="orange",fg="white")
                ...
                self.frame2 = LabelFrame(self.root,text="Download Playlist",width=180,height=180,font=('verdana',10,'bold'),bg="white",fg="orange",borderwidth=5,relief=SUNKEN,highlightcolor="orange",highlightbackground="orange")
                ...
                self.playlist_url = Entry(self.frame2,width=24,relief=SUNKEN,borderwidth=2,bg="orange",fg="white")
                ...
                self.playlist_path = Entry(self.frame2,width=15,relief=SUNKEN,borderwidth=2,bg="orange",fg="white")
                ...
                self.clear =  Button(self.root,text="Clear",font=('verdana',10,'bold'),bg="white",fg="orange",padx=10,relief=RAISED,borderwidth=3,command=self.Clear)
                self.clear.place(x=220,y=195)

                self.quit =  Button(self.root,text="Quit",font=('verdana',10,'bold'),bg="orange",fg="white",padx=15,relief=RAISED,borderwidth=3,command=self.Quit)
